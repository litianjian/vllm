...
class Qwen2VLProcessingInfo(BaseProcessingInfo):
    ...
    def _get_vision_info(
        ...
        *,
        ...
        # repeat the frames during preprocess
        grid_t = max(num_frames, 1)
    ...
    def get_dummy_processor_inputs(
        ...
        mm_data = {
            ...
            self._get_dummy_videos(
                width=target_width,
                height=target_height,
                num_frames=target_num_frames * video_frame_repeat,
...
class TTVFMForConditionalGeneration(nn.Module, SupportsMultiModal,
